...
The python file (process_log.py) is in "src" folder. It takes the input file (log.txt) from "log_input" folder 
and saves the results in "log_output" folder.

I've created an additional feature apart from the 4 features listed in the challenge. This features simply counts
the all the different types of requests made to the server and gives you the most popular request type by count and percentage.
